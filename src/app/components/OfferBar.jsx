...
export const OfferBar = () => {
  return (
    <div
      className="bg-[#111827] text-white py-2 md:py-4.5 lg:px-36"
      style={{
        fontWeight: 400,
        fontStyle: "normal",
        letterSpacing: "-0.2px",
    ...
    >
      ...
      <div className="block md:hidden px-3">
        ...
        {/* Bottom - Language and Currency Selectors */}
        <div className="flex items-center justify-center space-x-6 py-2">
          ...
          <div className="relative flex items-center">
            <Image
              ...
              className="mr-1"
            />
            <select className="bg-transparent text-white text-xs border-none focus:outline-none cursor-pointer appearance-none pr-5">
            ...
            <svg
              className="absolute right-0 top-1/2 transform -translate-y-1/2 w-3 h-3 pointer-events-none"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
